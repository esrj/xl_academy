"""
Django settings for XL_Academy_website project.
...
SECRET_KEY = 'django-insecure-0p2byudc5am@bh959_-dnu#qb!6rksd!qte3wuggp@%q5^j#l8'
...
ROOT_URLCONF = 'XL_Academy_website.urls'
...
WSGI_APPLICATION = 'XL_Academy_website.wsgi.application'
